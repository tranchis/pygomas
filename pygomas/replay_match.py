...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--game", default=None, help="The file that contains the battle to visualize"
    )
    parser.add_argument(
        "--fps",
        default=0.033,
        help="Frame rate speed to visualize the game in seconds per frame",
        type=float,
    )
    parser.add_argument(
        "--maps", default=None, help="The path to your custom maps directory.", type=str
    )
